...
In general, we expect you to follow our [Code of Conduct](https://github.com/gojek/WorkManager/blob/main/CODE_OF_CONDUCT.md).
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone git@github.com:YOUR_USERNAME/WorkManager.git
   # Navigate to the newly cloned directory
   cd WorkManager
   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:gojek/WorkManager.git
   ```
...
license your work under the same license as that used by the project, which is available [here](https://github.com/gojek/WorkManager/blob/main/LICENSE.md).
